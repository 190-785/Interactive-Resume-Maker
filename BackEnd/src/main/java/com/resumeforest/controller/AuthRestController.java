...
public class AuthRestController {
    ...
    /**
     * Login endpoint (alternative implementation)
     */
    @PostMapping("/login")
    ...
    /**
     * Registration endpoint (alternative implementation)
     * Moved to a different path to avoid conflict with AuthApiController
     */
    @PostMapping("/signup")
